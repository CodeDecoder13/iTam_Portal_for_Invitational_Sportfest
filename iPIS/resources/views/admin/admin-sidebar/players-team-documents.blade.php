<x-app-layout>
    ...
    <section class="grid grid-cols-1">
        ...
        <h3>Manage and Check Team Documents</h3>
                ...
                <div class="grid grid-cols-12 px-4 py-3 rounded-lg border mt-2">
                    ...
                    <div class="col-span-1 text-green-700">
                        @if ($a[0] == 'Summary of Players')
                            <a href="{{ route('team-documents', 'SummaryOfPlayers') }}">
                                <ion-icon name="document"></ion-icon>
                            </a>
                        @elseif ($a[0] == 'Gallery of Players')
                            <a href="{{ route('team-documents', 'GalleryOfPlayers') }}">
                                <ion-icon name="document"></ion-icon>
                            </a>
                        @elseif ($a[0] == 'Gallery of Coaches')
                            <a href="{{ route('team-documents', 'GalleryOfCoaches') }}">
                                <ion-icon name="document"></ion-icon>
                            </a>
                        @elseif ($a[0] == 'Parental Consent')
                            <a href="{{ route('team-documents', 'ParentalConsent') }}">
                                <ion-icon name="document"></ion-icon>
                            </a>
                        @elseif ($a[0] == 'Photocopy of School ID')
                            <a href="{{ route('team-documents', 'PhotocopyOfSchoolID') }}">
                                <ion-icon name="document"></ion-icon>
                            </a>
                        @elseif ($a[0] == 'Certificate of Registration')
                            <a href="{{ route('team-documents', 'CertificateOfRegistration') }}">
                                <ion-icon name="document"></ion-icon>
                            </a>
                        @elseif ($a[0] == 'Photocopy of Vaccine Card')
                            <a href="{{ route('team-documents', 'PhotocopyOfVaccineCard') }}">
                                <ion-icon name="document"></ion-icon>
                            </a>
                        @else
                            <a href="{{ route('team-documents', str_replace(' ', '', $a[0])) }}">
                                <ion-icon name="document"></ion-icon>
                            </a>
                        @endif
                    </div>
