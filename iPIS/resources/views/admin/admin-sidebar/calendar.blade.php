        ...
        <div class="mb-6">
            ...
            <div class="flex justify-between items-center mb-4">
                <div class="w-[45%]">
                    ...
                    <input type="text" id="school1" placeholder="School 1" class="w-full px-4 py-3 border rounded-md text-lg" readonly>
                </div>
                ...
                <div class="w-[45%]">
                    ...
                    <input type="text" id="school2" placeholder="School 2" class="w-full px-4 py-3 border rounded-md text-lg" readonly>
                </div>
            </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#school2Name').text(data.team2.school); 
                    ...
                    $('#gameDate').text(gameDate.toLocaleDateString('en-US', options)); // Format: October 11, 2024  this is the date of the game has the same id still not showing in the view modal
                    $('#sportCategory').text(data.sport_category);  // not showing with same id
    ...
    $('#addGameForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                location.reload();  // Optional: Reload the page to see the new game in the calendar
            },
            error: function(xhr) {
