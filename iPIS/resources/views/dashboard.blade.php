        ...
        @else
            ...
            <div class="flex flex-col items-center justify-center min-h-screen">
                <div class="text-center justify-center">
                    ...
                    <h1 class="text-xl font-semibold mb-4 justify-center">Your account is temporarily on hold for approval by our admins.</h1>
                    <p class="text-gray-600 mb-8 justify-center">Please allow 24-48 hours for the approval process. We appreciate your patience.</p>
            
                    <!-- Logout Button -->
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="px-4 py-2 bg-green-700 text-white rounded-full hover:bg-green-800 focus:outline-none justify-center">
                            Logout
                        </button>
                    </form>
                </div>
